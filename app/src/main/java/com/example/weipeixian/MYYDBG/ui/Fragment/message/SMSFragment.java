...
import com.example.weipeixian.MYYDBG.ui.activity.message.ShowSessionMessagesActivity;
import com.example.weipeixian.MYYDBG.ui.activity.message.send_sms;
...
public class SMSFragment extends BaseFragment{
    ...
    private List<SmsInfo> SourceDateList;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ImageButton imageButton = view.findViewById(R.id.return4);
            ...
            public void handleMessage(Message msg) {
                ...
                adapter.setOnItemClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        intent.putExtra("threadId",adapter.getmFilterList().get(position).getThread_id());
                        intent.putExtra("phone",adapter.getmFilterList().get(position).getPhone());
...
//                        final String  thread_id = smslist.get(position).getThread_id();
...
//                                        switch (which){
//                                            case 0:
//                                                Uri mUri=Uri.parse("content://sms/conversations/" +  Long.parseLong(thread_id));
//                                                mContext.getContentResolver().delete(mUri, null, null);
//                                                Log.d("deleteSMS", "threadId:: "+thread_id);
//
//                                                getMessageSessions();
//                                                break;
//                                        }
        ...
        try{
            ...
            if (sessionCursor.getCount() == 0){
                ...
                */
                    ...
                    smsinfo.setPhone(phoneAndUnread[0]);
                    int count = sessionCursor.getInt(message_countColumn);
                    contact = getContactFromPhoneNum(mContext, phoneAndUnread[0]);
                    //获得最后的未读短信与已读短信
                    int a = Integer.parseInt(phoneAndUnread[1]);
                    //将会话信息添加到信息列表中
