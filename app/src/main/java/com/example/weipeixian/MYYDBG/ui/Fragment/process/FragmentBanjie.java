...
public class FragmentBanjie extends BaseFragment {
    RecyclerView recyclerView;
    flowAdapter itemAdapter;
    View view;
    public FragmentBanjie() {}
    @Override
                ...
                if (e!=null){
                    ...
                    itemAdapter.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                            ...
                            startActivity(new Intent(getActivity(), flow_monitor.class).putExtra("from",3).putExtra("id",avObject.getObjectId()));
                        }
                    });
                }
            }
