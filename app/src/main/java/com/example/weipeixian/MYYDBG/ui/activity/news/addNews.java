...
public class addNews extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                pd=new ProgressDialog(addNews.this);
                pd.setTitle("上传");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AVObject avObject =new AVObject("News");
        ...
        try {
            ...
            file.saveInBackground(new SaveCallback() {
                ...
                public void done(AVException e) {
                    pd.dismiss();
                    if (e ==null){
                        Toast.makeText(addNews.this,"上传成功",Toast.LENGTH_SHORT).show();
                    }
                    else {
                        Toast.makeText(addNews.this,"上传失败",Toast.LENGTH_SHORT).show();
                    }
                }
