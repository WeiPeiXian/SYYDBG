...
public class SMSHostActivity extends FragmentActivity {
    ...
    public static final String SHOW_OF_CHAT_TAG = "message";
    public static final String SHOW_OF_PHONE_TAG = "chat";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TabHost.TabSpec tabSpec1 = mFragmentTabhost.newTabSpec(SHOW_OF_CHAT_TAG)
                .setIndicator("1");
        mFragmentTabhost.addTab(tabSpec0, FragmentPhone.class, null);
